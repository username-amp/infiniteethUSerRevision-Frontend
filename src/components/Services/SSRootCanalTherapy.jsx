...
import rootCanal from '../../shared/components/Partials/assets/root-canal.jpg';

const SSRootCanalTherapy = () => {
    return (
        <div className="w-full p-16 mb-10">
          <div className="flex flex-col md:flex-row gap-10 justify-center items-start">
            <div className="flex flex-col items-start ">
              <h1 className="text-3xl font-bold text-orange-500 mb-9">Root Canal Therapy</h1>
              <img src={rootCanal} alt="Tooth Fillings" className="w-96" />
...
export default SSRootCanalTherapy