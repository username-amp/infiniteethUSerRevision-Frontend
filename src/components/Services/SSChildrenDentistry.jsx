...
import childDentistry from '../../shared/components/Partials/assets/childDentistry.jpg';

const SSChildrenDentistry = () => {
    return (
        <div className="w-full p-16 mb-10">
          <div className="flex flex-col md:flex-row gap-10 justify-center items-start">
            <div className="flex flex-col items-start ">
              <h1 className="text-2xl font-bold text-orange-500 mb-9">Children's Dentistry Services</h1>
              <img src={childDentistry} alt="Tooth Fillings" className="w-96" />
              <h1 className="text-3xl font-bold text-orange-500 mt-9">(Pediatric Dentistry)</h1>
            </div>
...
export default SSChildrenDentistry