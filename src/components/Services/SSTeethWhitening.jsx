...
import whitening from '../../shared/components/Partials/assets/whitening.jpg';

const SSTeethWhitening = () => {
    return (
        <div className="w-full p-16 mb-10">
          <div className="flex flex-col md:flex-row gap-10 justify-center items-start">
            <div className="flex flex-col items-start ">
              <h1 className="text-3xl font-bold text-orange-500 mb-9">Cosmetic, Smile <br /> Management, and Teeth <br /> Whitening / Bleaching <br />Dentistry</h1>
              <img src={whitening} alt="Tooth Fillings" className="w-96" />
              <h1 className="text-3xl font-bold text-orange-500 mt-9">(RCT)</h1>
            </div>
...
export default SSTeethWhitening