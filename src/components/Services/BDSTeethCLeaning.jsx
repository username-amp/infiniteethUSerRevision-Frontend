...
import toothCleaning from '../../shared/components/Partials/assets/teethCleaning.jpg';


const BDSTeethCLeaning = () => {
    return (
        <div className="w-full p-16 mb-10">
          <div className="flex flex-col md:flex-row gap-10 justify-center items-start">
            <div className="flex flex-col items-start ">
              <h1 className="text-3xl font-bold text-orange-500 mb-9">Tooth CLeaning</h1>
              <img src={toothCleaning} alt="Tooth Fillings" className="w-96" />
            </div>
...
export default BDSTeethCLeaning