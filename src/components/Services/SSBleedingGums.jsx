...
import gums from '../../shared/components/Partials/assets/gums.jpg';

const SSBleedingGums = () => {
    return (
        <div className="w-full p-16 mb-10 ">
            ...
            <div className="flex flex-col items-start ">
              <h1 className="text-2xl font-bold text-orange-500 mb-9">Gum Diseases / Bleeding Gums  <br />Management</h1>
              <img src={gums} alt="Tooth Fillings" className="w-96" />
              <h1 className="text-3xl font-bold text-orange-500 mt-9">(Periodontal Services)</h1>
            </div>
            </div>
        </div>
      )
